...
(function (factory) {
    ...
    Highcharts.setOptions({
        lang: {
            downloadCSV: 'Download data in CSV'
        }
    });
...
//            csv += row.join(itemDelimiter);
    ...
    function getContent(chart, href, extension, content, MIME) {
        ...
        if (chart.options.exporting.filename) {
            ...
            var dt = chart.subtitle.textStr.toLowerCase();
            name = chart.title.textStr.replace(/ /g, '_').toLowerCase() + '__' + dt.substr(dt.length - 10);
        } else {
            name = 'chart';
        }
